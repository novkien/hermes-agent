...
async def _handle_stop_run(
    ...
    *,
    ...
    if agent is not None:
        ...
        # A registered run whose agent has not been built yet may still be
        # loading history or resolving its provider. Cancelling the wrapper
        # task keeps an early stop from being silently ignored.
        task.cancel()
