...
| 相关技能 | `ascii-video`、`manim-video`、`p5js`、`touchdesigner-mcp`、`pixel-art`、`ascii-art`、`songwriting-and-ai-music`、[`heartmula`](/user-guide/skills/optional/creative/creative-heartmula)、`songsee`、`youtube-content`、`claude-design`、`excalidraw`、`architecture-diagram`、[`concept-diagrams`](/user-guide/skills/optional/creative/creative-concept-diagrams)、`baoyu-comic`、`baoyu-infographic`、`humanizer`、`gif-search`、[`meme-generation`](/user-guide/skills/optional/creative/creative-meme-generation) |
