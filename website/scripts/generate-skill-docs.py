#!/usr/bin/env python3
"""Generate per-skill Docusaurus pages from optional-skills/ SKILL.md files.

Each skill gets website/docs/user-guide/skills/<source>/<category>/<skill-name>.md
where <source> is "optional".
...
Sidebar is updated to nest all per-skill pages under Skills → Optional.
"""
