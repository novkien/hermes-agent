...
| **Node.js 22.22+** | Opcional — necesario para herramientas de navegador y puente WhatsApp; el instalador administrado y las compilaciones de escritorio requieren actualmente Node.js 26+ |
