        ...
        return [
            {
                ...
                "ahead": 0,
                "behind": 0,
                "path": "/secret/checkout",
                "origin_url": "ssh://private.example/repo",
            ...
            "services": [
                {
                    ...
                    "recent_logs": "never persist this log body",
                    "health": "healthy",
                }
            ],
            "api": [
...
async def main_async() -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        assert pending_args[:4] == ("audit.changed", "control-store", "audit", "1")
        ...
        updated = [
            {**row, "health": "degraded"}
            if row["entity_key"] == "services:svc-1"
            else row
