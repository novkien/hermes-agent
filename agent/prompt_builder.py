...
TOOL_USE_ENFORCEMENT_GUIDANCE = (
    ...
    "When the next step depends on an external result, yield under the active "
    "completion contract. Report a precise dependency when no authorized action "
...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- Continue available authorized actions; when a required return is pending, "
    "yield under the active completion contract rather than polling.\n"
    "</tool_persistence>\n"
    "\n"
    "<mandatory_tool_use>\n"
