...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        f"Description: long descriptions are truncated to the first {SKILL_PROMPT_DESC_LIMIT - 3} chars "
        ...
        f"first {SKILL_PROMPT_DESC_LIMIT - 3}-char window: 'Use when <trigger>. <one-line behavior>.'\n\n"
